package com.amaze.filemanager.provider;
...
public class Constants {
    public static final String AUTHORITY = "com.amaze.filemanager";
    ...
    public static class State {
        public final static int STATE_IDEL = 1; //停止
        public final static int STATE_TRANSFERING = 2;
        public final static int STATE_PENDING = 3; //等待
